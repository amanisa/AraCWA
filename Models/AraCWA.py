...
def main(args):
	...
	for i in range(0,14):
		...
		samples_data = samples_data[["topic_id" , "tweet_id" , "tweet_text" ,"claim_worthiness" , "claim"]] 
		train_data = pd.concat([train_data, samples_data])
...
if __name__ == '__main__':
	...
	parser.add_argument('--samples_data_path', default="./samples_200/", help='path of samples set')
