...
def get_score(test_path, co_score_path, true_labels , predictions, counter, topic, result_path):
	...
	if counter == 14:
		...
		tsv_file = "AraCWA(CWE).tsv"
		excel_file = "AraCWA(CWE).xlsx"
...
def main(args):
	print(" Start AraCWA(CWE) Experiment")
	...
	ori_smpl_set = ["CT20-AR-01_smpl_200" ,"CT20-AR-02_smpl_200", "CT20-AR-05_smpl_200", "CT20-AR-08_smpl_200", "CT20-AR-10_smpl_200",
	...
	WE_smpl_set = ["CT20-AR-01_smpl_200_WE" ,"CT20-AR-02_smpl_200_WE", "CT20-AR-05_smpl_200_WE", "CT20-AR-08_smpl_200_WE", "CT20-AR-10_smpl_200_WE",
    "CT20-AR-12_smpl_200_WE", "CT20-AR-14_smpl_200_WE", "CT20-AR-19_smpl_200_WE", "CT20-AR-23_smpl_200_WE", "CT20-AR-27_smpl_200_WE", "CT20-AR-30_smpl_200_WE",
    "Covid-19_smpl_200_WE", "CT21-AR-01_smpl_200_WE", "CT21-AR-02_smpl_200_WE"]

	test_sets = ["CT20-AR-01_new_gold" ,"CT20-AR-02_new_gold", "CT20-AR-05_new_gold", "CT20-AR-08_new_gold", "CT20-AR-10_new_gold",
     "CT20-AR-12_new_gold", "CT20-AR-14_new_gold", "CT20-AR-19_new_gold", "CT20-AR-23_new_gold", "CT20-AR-27_new_gold", "CT20-AR-30_new_gold",
     "Covid-19_new_gold", "CT21-AR-01_new_gold", "CT21-AR-02_new_gold"]
	...
	for i in range(0,14):
		...
		ori_samples_path = os.path.join(args.ori_samples_data_path,ori_smpl_set[i]+suffix)
		WE_samples_path = os.path.join(args.WE_samples_data_path,WE_smpl_set[i]+suffix)
		test_path = os.path.join(args.test_data_path,test_sets[i]+suffix)
		co_score_suffix= '_scores_AraCWA(CWE).tsv'
		co_score_path = os.path.join(args.pred_data_path, topics[i] + co_score_suffix)
		pred_suffix= '_pred_AraCWA(CWE).tsv'
		...
		ori_samples_data = pd.read_csv(ori_samples_path, delimiter = "\t" ,encoding='utf-8')
		WE_samples_data = pd.read_csv(WE_samples_path, delimiter = "\t" ,encoding='utf-8')
		test_data = pd.read_csv(test_path, delimiter = "\t" ,encoding='utf-8')
		ori_samples_data = ori_samples_data[["topic_id" , "tweet_id" , "tweet_text" ,"claim_worthiness" , "claim"]] 
		train_data = pd.concat([train_data, ori_samples_data])
		WE_samples_data.drop("tweet_text", axis=1, inplace=True)
		WE_samples_data = WE_samples_data[["topic_id" , "tweet_id" , "WE_text", "claim_worthiness" , "claim"]] 
		WE_samples_data.rename(columns = {'WE_text':'tweet_text'}, inplace = True)
		train_data = pd.concat([train_data, WE_samples_data])
...
if __name__ == '__main__':
	...
	parser.add_argument('--train_data_path', default="./train/", help='path of training file')
	parser.add_argument('--ori_samples_data_path', default="./samples_200/", help='path of original samples file')
	parser.add_argument('--WE_samples_data_path', default="./WE_200/", help='path of WE samples file')
	parser.add_argument('--test_data_path', default="./new_gold/", help='path of test file')
