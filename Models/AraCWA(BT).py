...
def get_score(test_path, co_score_path, true_labels , predictions, counter, topic, result_path):
	...
	if counter == 14:
		...
		tsv_file = "AraCWA(BT).tsv"
		excel_file = "AraCWA(BT).xlsx"
...
def main(args):
	...
	print(" Start AraCWA(BT) Experiment")
	...
	BT_smpl_set = ["CT20-AR-01_smpl_200_BT" ,"CT20-AR-02_smpl_200_BT", "CT20-AR-05_smpl_200_BT", "CT20-AR-08_smpl_200_BT", "CT20-AR-10_smpl_200_BT",
    "CT20-AR-12_smpl_200_BT", "CT20-AR-14_smpl_200_BT", "CT20-AR-19_smpl_200_BT", "CT20-AR-23_smpl_200_BT", "CT20-AR-27_smpl_200_BT", "CT20-AR-30_smpl_200_BT",
    "Covid-19_smpl_200_BT", "CT21-AR-01_smpl_200_BT", "CT21-AR-02_smpl_200_BT"]
	...
	for i in range(0,14):
		...
		BT_samples_path = os.path.join(args.BT_samples_data_path,BT_smpl_set[i]+suffix)
		test_path = os.path.join(args.test_data_path,test_sets[i]+suffix)
		co_score_suffix= '_scores_AraCWA(BT).tsv'
		co_score_path = os.path.join(args.pred_data_path, topics[i] + co_score_suffix)
		pred_suffix= '_pred_AraCWA(BT).tsv'
		...
		BT_samples_data = pd.read_csv(BT_samples_path, delimiter = "\t" ,encoding='utf-8')
		...
		BT_samples_data.drop("tweet_text", axis=1, inplace=True)
		BT_samples_data.drop("en", axis=1, inplace=True)
		BT_samples_data = BT_samples_data[["topic_id" , "tweet_id" , "ar", "claim_worthiness" , "claim"]] 
		BT_samples_data.rename(columns = {'ar':'tweet_text'}, inplace = True)
		train_data = pd.concat([train_data, BT_samples_data])
...
if __name__ == '__main__':
	...
	parser.add_argument('--BT_samples_data_path', default="./BT_200/", help='path of BT samples ')
